...
public class FrCadastroCliente extends javax.swing.JFrame {
    ...
    public void atualizarTabela(Cliente usr) {
        this.lstUsuarios.clear();
        ClienteDAO usrDAO = new ClienteDAO();
        ArrayList<Object> arrayObj = usrDAO.consultar(usr == null ? null : usr);
        for(int i=0; i<arrayObj.size(); i++){
            lstUsuarios.add((Cliente)arrayObj.get(i));
        }
        ...
        for (int i=0; i<lstUsuarios.size(); i++) {
            dtm.addRow(new Object[]{
                ...
                lstUsuarios.get(i).getDataNasc(), lstUsuarios.get(i).getEndereco()});
        }
    ...
    public void update(){
        try {
            ...
            usr.setEndereco(edtEndereco.getText());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(grdUsuarios.getSelectedRow() != -1){
            ...
            edtEndereco.setText(usr.getEndereco());   
            this.habilitarBotoes(false, true, false, false, true, false, false, false);
            this.habilitarCampos(true);
