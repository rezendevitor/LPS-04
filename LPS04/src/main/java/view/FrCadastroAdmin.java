...
public class FrCadastroAdmin extends javax.swing.JFrame {
    ...
    public void atualizarTabela(Administrador usr){
        this.lstUsuarios.clear(); 
        AdministradorDAO usrDAO = new AdministradorDAO();
        ArrayList<Object> arrayObj = usrDAO.consultar(usr == null ? null : usr);
        for(int i=0; i<arrayObj.size(); i++){
            lstUsuarios.add((Administrador)arrayObj.get(i));
        }
        DefaultTableModel dtm = (DefaultTableModel) grdUsuarios.getModel();
        dtm.setNumRows(0);
        for (int i=0; i<lstUsuarios.size(); i++) {
            dtm.addRow(new Object[]{
                lstUsuarios.get(i).getNome(), lstUsuarios.get(i).getCpf(), lstUsuarios.get(i).getTelefone(),
                lstUsuarios.get(i).getEmail(), lstUsuarios.get(i).getSenha(), lstUsuarios.get(i).getSexo(),
                lstUsuarios.get(i).getDataNasc(), lstUsuarios.get(i).getSalario()});
        }
    ...
    public void update(){
        try {
            ...
            usr.setNome(edtNome.getText());
            usr.setTelefone(ftxTelefone.getText());
            usr.setEmail(edtEmail.getText());
            usr.setSenha(senha);
            usr.setSexo(cbxSexo.getSelectedItem().toString());
            usr.setDataNasc(datasql);
            usr.setSalario(Float.parseFloat(edtSalario.getText()));
            usr.setCpf(ftxCPF.getText());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(grdUsuarios.getSelectedRow() != -1){
            ...
            int id = buscar(cpf);
            usr = this.lstUsuarios.get(id);
        }if(usr != null){
            edtNome.setText(usr.getNome());
            ftxCPF.setText(usr.getCpf()+"");
            ftxTelefone.setText(usr.getTelefone());
            edtEmail.setText(usr.getEmail());
            pswSenha.setText(usr.getSenha());
            cbxSexo.setSelectedItem(usr.getSexo());
            Date dataNasc = usr.getDataNasc();
            ftxDataNasc.setText(dataNasc+"");
            edtSalario.setText(usr.getSalario()+"");   
            this.habilitarBotoes(false, true, false, false, true, false, false, false);
            this.habilitarCampos(true);
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if(cpfInformado.equals(null)){
            ...
            this.atualizarTabela(this.lstUsuarios.get(indice));
        }
